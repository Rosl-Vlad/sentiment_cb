...
channels = ['breakingmash', 'rian_ru', 'ostorozhno_novosti', 'moscowmap', 'u_now', 'DavydovIn', 'bbbreaking',
            'rusich_army',
            ...
            'milinfolive',
            'itsdonetsk', 'lentachold', 'AteoBreaking', 'ru2ch_news', 'zhest_belgorod', 'zerkalo_io']
...
mega_df.to_csv("out36channels.csv")
